...
This guru.springframework.spring5webapp.repositories is for an example application built in my [Spring Framework 5 - Beginner to Guru](https://www.udemy.com/testing-spring-boot-beginner-to-guru/?couponCode=GITHUB_REPO) online course
...
As you work through the course, please feel free to fork this guru.springframework.spring5webapp.repositories to your out GitHub repo. Most links contain links 
